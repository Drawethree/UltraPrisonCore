...
**UltraPrisonCore** is an **ultimate solution** for your prison server. This core contains **everything** that should be on each prison server. By including **20+ Custom Enchants**, **Auto-Sell**, **Auto-Miner** region, **Pickaxe Levels**, **Tokens & Gems** currencies, **Ranks & Prestiges**, **Multipliers** and a lot of more, its one of the **best prison cores** on the market.

# Pages
### General
* [Home](https://github.com/Drawethree/UltraPrisonCore/wiki)
...
* [Terms of Service](https://github.com/Drawethree/UltraPrisonCore/blob/main/terms-of-service.pdf)
### Default Files
...
* [_autosell.yml_](https://github.com/Drawethree/UltraPrisonCore/wiki/autosell.yml)
* [_block-rewards.yml_](https://github.com/Drawethree/UltraPrisonCore/wiki/block-rewards.yml)
* [_enchants.yml_](https://github.com/Drawethree/UltraPrisonCore/wiki/enchants.yml)
* [_gems.yml_](https://github.com/Drawethree/UltraPrisonCore/wiki/gems.yml)
* [_multipliers.yml_](https://github.com/Drawethree/UltraPrisonCore/wiki/multipliers.yml)
